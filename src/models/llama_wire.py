...
class GraphLlamaModel(LlamaModel):
    ...
    def _update_causal_mask(
        ...
        # 1. Check for your custom condition
        # If it's 4D, we assume it's a custom bidirectional mask and return it as-is
        if attention_mask is not None and attention_mask.dim() == 4:
            return attention_mask

        # 2. Otherwise, call the parent method to use the default causal logic
