"""Dry-run every run through the real parser + validator before submission.
    ...
    python -m src.experiments.bias_experiments.nonlinear_bias.preflight
...
_CONFIGS = [
    ("src.experiments.kgqa",
     "src/experiments/bias_experiments/nonlinear_bias/configs/032_webqsp_nonlinear.jsonc"),
    ("src.experiments.graphqa",
     "src/experiments/bias_experiments/nonlinear_bias/configs/033_graphqa_nonlinear.jsonc"),
    ("src.experiments.graphqa",
     "src/experiments/bias_experiments/nonlinear_bias/configs/034_graphqa_nonlinear_hot.jsonc"),
    ("src.experiments.kgqa",
     "src/experiments/bias_experiments/nonlinear_bias/configs/035_webqsp_nonlinear_hot.jsonc"),
]
