...
#
#   ./src/experiments/bias_experiments/mixed_bias/sbatch_diagnose_nan.sh
# =============================================================================
set -euo pipefail
...
DIAGDIR="$REPO/src/experiments/bias_experiments/mixed_bias/results/diagnostic"
...

{
  ...
  echo "python -m src.experiments.bias_experiments.mixed_bias.diagnose_nan \
