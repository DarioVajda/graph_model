"""Dry-run every Phase 2 run through the real parser + validator before submission.
    ...
    python -m src.experiments.bias_experiments.mixed_bias.preflight
...
_CONFIGS = [
    ("src.experiments.kgqa", "src/experiments/bias_experiments/mixed_bias/configs/018_webqsp_mixed.jsonc"),
    ("src.experiments.graphqa", "src/experiments/bias_experiments/mixed_bias/configs/019_graphqa_mixed.jsonc"),
    ("src.experiments.context", "src/experiments/bias_experiments/mixed_bias/configs/020_context4k_mixed.jsonc"),
    ("src.experiments.kgqa", "src/experiments/bias_experiments/mixed_bias/configs/022_webqsp_magnitude_repro.jsonc"),
    ("src.experiments.kgqa", "src/experiments/bias_experiments/mixed_bias/configs/023_webqsp_mixed_arms34.jsonc"),
    ("src.experiments.graphqa", "src/experiments/bias_experiments/mixed_bias/configs/024_graphqa_linear_v2.jsonc"),
    ("src.experiments.kgqa", "src/experiments/bias_experiments/mixed_bias/configs/025_webqsp_linear_v2.jsonc"),
]
