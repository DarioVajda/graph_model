"""Per-parameter-group gradient diagnostic for the 020 hybrid divergence.
    ...
    python -m src.experiments.bias_experiments.mixed_bias.diagnose_nan <exact flags of the failing run>
...
OUT = os.environ.get(
    "DIAG_OUT",
    "src/experiments/bias_experiments/mixed_bias/results/diagnostic/grad_norms.jsonl")
