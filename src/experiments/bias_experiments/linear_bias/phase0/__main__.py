"""Phase 0 driver — run the offline linearization measurements over an M-grid.
    ...
    python -m src.experiments.bias_experiments.linear_bias.phase0 \
        --job src/experiments/bias_experiments/bias_sharing/results/002_webqsp_g_sweep/jobs/<...>.sh \
        --run-dir checkpoints/kgqa/002_webqsp_g_sweep_0000_seed0_magnetic_groups0 \
        --out src/experiments/bias_experiments/linear_bias/results/p0_webqsp_seed0.json
