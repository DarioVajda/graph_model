...
#
#   ./src/experiments/bias_experiments/bias_sharing/sbatch_context4k_data.sh [PARTITION]
# =============================================================================
set -euo pipefail
...
echo "      src/experiments/bias_experiments/bias_sharing/configs/003_context4k_g_sweep.jsonc"
