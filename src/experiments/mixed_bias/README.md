...
python3 -m sweep src.experiments.kgqa    src/experiments/mixed_bias/configs/021_webqsp_baselines.jsonc
python3 -m sweep src.experiments.kgqa    src/experiments/mixed_bias/configs/023_webqsp_mixed_arms34.jsonc
...
python3 -m sweep src.experiments.graphqa src/experiments/mixed_bias/configs/024_graphqa_linear_v2.jsonc
python3 -m sweep src.experiments.kgqa    src/experiments/mixed_bias/configs/025_webqsp_linear_v2.jsonc
...
sbatch -p frida -c 4 --mem 32G -t 00:10:00 -A povejmo -J gate_audit -o <log> --wrap \
  'exec srun --container-image=<sqsh> --container-mounts=/shared:/shared \
   ...
   env HOME=$HOME bash -c ".venv/bin/python -m src.experiments.mixed_bias.gate_audit \
