"""Dry-run every Phase 2 run through the real parser + validator before submission.
    ...
    python -m src.experiments.linear_bias.preflight
...
_CONFIGS = [
    ("src.experiments.kgqa", "src/experiments/linear_bias/configs/010_webqsp_linear.jsonc"),
    ("src.experiments.context", "src/experiments/linear_bias/configs/011_context4k_linear.jsonc"),
